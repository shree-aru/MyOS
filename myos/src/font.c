/* ============================================================================
 * MyOS - 8x16 Bitmap Font
 * Public domain VGA-style font for framebuffer text rendering
...
/* Font data for ASCII 32-126 (95 printable characters) */
static const uint8_t font_data[95][16] = {
    ...
    /* 89: Y */
    {0x00,0x00,0xC3,0xC3,0x66,0x3C,0x18,0x18,0x18,0x18,0x3C,0x00,0x00,0x00,0x00,0x00},
    /* 90: Z */
...
const uint8_t* font_get_glyph(char c) {
    if (c < 32 || c > 126)
        return font_data[0];  /* Return space for unprintable chars */
